	...
	<div class="loginR">
		<div class="form-box">
			<div class="button-box">
				<div id="btn"></div>
				<button type="button" class="toggle-btn"><a href="login.php" style="font-family:Monserrat;">Log In</a></button>
				<button type="button" class="toggle-btn" style="background:linear-gradient(to right,rgb(151,244,60),rgb(228,245,27));margin-left:15px; font-family:MonserratB;"><a href="#">Register</a></button>
			</div>
			<div class="icons">
				<i class="fab fa-facebook-f" style="padding:5px 10px;"></i>
				<i class="fab fa-twitter"></i>
				<i class="fab fa-google-plus-g"></i>
			</div>
			<form id="register" class="input-group">
				<input type="text" class="input-field" placeholder="Enter User Id" required style="font-family:Monserrat;">
				<input type="text" class="input-field" placeholder="Enter Email Id" required style="font-family:Monserrat;">
				<input type="text" class="input-field" placeholder="Create Password" required style="font-family:Monserrat;">
				<input type="checkbox" class="check-box" required><span>I agree to the terms & conditions.</span>
				<button type="submit" class="submit-btn" style="font-family:MonserratB;">Register</button>
			</form>
		</div>
	</div>
	<!-- ---------------------------     Footer     -------------------------------- -->
