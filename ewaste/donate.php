		...
		<div class="contact-bg">
			<div class="inner-bg">
				<div class="left-inner-bg">
					<p style="font-family:Abril;font-size:1.5em;">DONATE</p>
					<p style="font-size:0.9em;text-transform:uppercase;">We endeavour to make the process extremely<br> simple for you and make customer<br> satisfaction the core of our service.</p>
				</div>
			...
			<div class="maincontent3">
				<div class="form-box">
					<div  class="donate-h3"><b><i class="fas fa-recycle" style="color:white; font-size:1.2em;"></i></b><br/>
						<h3>DONATE E-WASTE</h3>
					</div>
					<div class="lower-form">
						<form action="donate.php" method="POST" class="input-group" style="font-size:0.9em;text-align:left;">
							...
							<label for="wastetype">What Things You Want To Donate?</label><span style="color:rgb(240,4,4);">&nbsp;*</span><br/>
